package com.gorih.family_coffers.server.config;
...
@Configuration
@EnableJpaRepositories("com.gorih.family_coffers.server.repository")
@EnableTransactionManagement
@ComponentScan("com.gorih.family_coffers.server")
...
public class DatabaseConfig  {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setTimeBetweenEvictionRunsMillis(Long.valueOf(environment.getRequiredProperty("db.timeBetweenEvictionsRunsMillis")));
